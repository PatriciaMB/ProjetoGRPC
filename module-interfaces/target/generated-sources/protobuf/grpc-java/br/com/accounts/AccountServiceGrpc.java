...
public final class AccountServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Int32Value,
      br.com.accounts.Account> getGetAccountMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetAccount",
      requestType = com.google.protobuf.Int32Value.class,
      responseType = br.com.accounts.Account.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Int32Value,
      br.com.accounts.Account> getGetAccountMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Int32Value, br.com.accounts.Account> getGetAccountMethod;
      ...
      synchronized (AccountServiceGrpc.class) {
        if ((getGetAccountMethod = AccountServiceGrpc.getGetAccountMethod) == null) {
          AccountServiceGrpc.getGetAccountMethod = getGetAccountMethod = 
              io.grpc.MethodDescriptor.<com.google.protobuf.Int32Value, br.com.accounts.Account>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  br.com.accounts.Account.getDefaultInstance()))
  ...
  public static abstract class AccountServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getAccount(com.google.protobuf.Int32Value request,
        io.grpc.stub.StreamObserver<br.com.accounts.Account> responseObserver) {
  ...
  public static final class AccountServiceBlockingStub extends io.grpc.stub.AbstractStub<AccountServiceBlockingStub> {
    ...
    /**
     */
    public br.com.accounts.Account getAccount(com.google.protobuf.Int32Value request) {
  ...
  public static final class AccountServiceFutureStub extends io.grpc.stub.AbstractStub<AccountServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<br.com.accounts.Account> getAccount(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ACCOUNT:
          serviceImpl.getAccount((com.google.protobuf.Int32Value) request,
              (io.grpc.stub.StreamObserver<br.com.accounts.Account>) responseObserver);
          break;
        default:
  ...
  private static abstract class AccountServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return br.com.accounts.AccountOuterClass.getDescriptor();
    }
